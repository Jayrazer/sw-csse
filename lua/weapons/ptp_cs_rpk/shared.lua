...
SWEP.ViewModel			= "models/weapons/csse/c_mach_rpk.mdl"
...
SWEP.CrouchWalkCone			= 0.04 -- Accuracy when we're crouching and walking
SWEP.WalkCone				= 0.08 -- Accuracy when we're walking
SWEP.AirCone				= 0.125 -- Accuracy when we're in air
SWEP.StandCone				= 0.05 -- Accuracy when we're standing still
SWEP.Delay					= 60 / 500
SWEP.Recoil					= 3
SWEP.RecoilZoom				= 1
SWEP.IronSightsCone			= 0.04
