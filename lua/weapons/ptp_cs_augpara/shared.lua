...
SWEP.ViewModel			= "models/weapons/csse/c_smg_augpara.mdl"
...
SWEP.AimSightsPos 		= Vector( -4, 0, 0 )
...
SWEP.Delay				= 60 / 650	-- Delay For Not Zoom
SWEP.DelayZoom				= 60 / 500	-- Delay For Zoom